  ...
  return (
    ...
    >
      <style>{`
        ...
        .toptal-hex { --h: polygon(50% 0,100% 24%,100% 76%,50% 100%,0 76%,0 24%); }
        .toptal-outer { display:inline-block; background:#25a9ef; padding:6px; clip-path:var(--h); }
        .toptal-inner { width:200px; padding:24px 0 40px; display:flex; flex-direction:column; align-items:center; gap:8px; color:#fff; text-align:center; background:linear-gradient(153deg,#0667ff 18%,#204ecf 40%,#0f256e 80%); clip-path:var(--h); box-shadow:0 28px 50px rgba(6,30,96,.35); }
        .toptal-title { margin:0; font-size:19px; font-weight:700; line-height:1; }
        .toptal-divider { width:120px; height:1px; background:#25a9ef; }
        .toptal-vetted { font-size:16px; opacity:.8; margin-bottom:-6px; }
        .toptal-hire { display:inline-flex; align-items:center; justify-content:center; padding:4px 20px; border-radius:6px; background:#296bff; color:#fff; font-size:16px; font-weight:500; text-decoration-thickness:.5px; text-underline-offset:2px; }
      `}</style>
      <div className="toptal-hex toptal-outer">
        <div className="toptal-hex toptal-inner">
          ...
          <a
            target="_blank"
            className="toptal-hire"
            href="https://www.toptal.com/developers/resume/avaaj-gyawali#B7yKDQ"
            rel="noreferrer"
          >
            Hire me
          </a>
